...
_MSGUPGRADECLIENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\033yaml:\"proof_upgrade_client\"')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037$yaml:\"proof_upgrade_consensus_state\"')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_MSGCREATECLIENT.fields_by_name['client_state'].has_options = True
_MSGCREATECLIENT.fields_by_name['client_state']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\023yaml:\"client_state\"'))
_MSGCREATECLIENT.fields_by_name['consensus_state'].has_options = True
_MSGCREATECLIENT.fields_by_name['consensus_state']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\026yaml:\"consensus_state\"'))
_MSGCREATECLIENT.has_options = True
_MSGCREATECLIENT._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\000\210\240\037\000'))
_MSGUPDATECLIENT.fields_by_name['client_id'].has_options = True
_MSGUPDATECLIENT.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_MSGUPDATECLIENT.has_options = True
_MSGUPDATECLIENT._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\000\210\240\037\000'))
_MSGUPGRADECLIENT.fields_by_name['client_id'].has_options = True
_MSGUPGRADECLIENT.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_MSGUPGRADECLIENT.fields_by_name['client_state'].has_options = True
_MSGUPGRADECLIENT.fields_by_name['client_state']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\023yaml:\"client_state\"'))
_MSGUPGRADECLIENT.fields_by_name['consensus_state'].has_options = True
_MSGUPGRADECLIENT.fields_by_name['consensus_state']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\026yaml:\"consensus_state\"'))
_MSGUPGRADECLIENT.fields_by_name['proof_upgrade_client'].has_options = True
_MSGUPGRADECLIENT.fields_by_name['proof_upgrade_client']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\033yaml:\"proof_upgrade_client\"'))
_MSGUPGRADECLIENT.fields_by_name['proof_upgrade_consensus_state'].has_options = True
_MSGUPGRADECLIENT.fields_by_name['proof_upgrade_consensus_state']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037$yaml:\"proof_upgrade_consensus_state\"'))
_MSGUPGRADECLIENT.has_options = True
_MSGUPGRADECLIENT._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\000\210\240\037\000'))
_MSGSUBMITMISBEHAVIOUR.fields_by_name['client_id'].has_options = True
_MSGSUBMITMISBEHAVIOUR.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_MSGSUBMITMISBEHAVIOUR.has_options = True
_MSGSUBMITMISBEHAVIOUR._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\000\210\240\037\000'))
