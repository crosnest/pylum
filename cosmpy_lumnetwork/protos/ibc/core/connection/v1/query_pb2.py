...
_QUERYCONNECTIONRESPONSE.fields_by_name['proof_height'].has_options = True
_QUERYCONNECTIONRESPONSE.fields_by_name['proof_height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCONNECTIONSRESPONSE.fields_by_name['height'].has_options = True
_QUERYCONNECTIONSRESPONSE.fields_by_name['height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCLIENTCONNECTIONSRESPONSE.fields_by_name['proof_height'].has_options = True
_QUERYCLIENTCONNECTIONSRESPONSE.fields_by_name['proof_height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCONNECTIONCLIENTSTATEREQUEST.fields_by_name['connection_id'].has_options = True
_QUERYCONNECTIONCLIENTSTATEREQUEST.fields_by_name['connection_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\024yaml:\"connection_id\"'))
_QUERYCONNECTIONCLIENTSTATERESPONSE.fields_by_name['proof_height'].has_options = True
_QUERYCONNECTIONCLIENTSTATERESPONSE.fields_by_name['proof_height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCONNECTIONCONSENSUSSTATEREQUEST.fields_by_name['connection_id'].has_options = True
_QUERYCONNECTIONCONSENSUSSTATEREQUEST.fields_by_name['connection_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\024yaml:\"connection_id\"'))
_QUERYCONNECTIONCONSENSUSSTATERESPONSE.fields_by_name['proof_height'].has_options = True
_QUERYCONNECTIONCONSENSUSSTATERESPONSE.fields_by_name['proof_height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0025\0223/ibc/core/connection/v1/connections/{connection_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='Connections',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002%\022#/ibc/core/connection/v1/connections')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0028\0226/ibc/core/connection/v1/client_connections/{client_id}')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002B\022@/ibc/core/connection/v1/connections/{connection_id}/client_state')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002y\022w/ibc/core/connection/v1/connections/{connection_id}/consensus_state/revision/{revision_number}/height/{revision_height}')),
  ),
])
