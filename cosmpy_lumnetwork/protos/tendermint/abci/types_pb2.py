...
_CHECKTXTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\212\235 \003New')),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RECHECK', index=1, number=1,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\212\235 \007Recheck')),
      type=None),
  ],
...
_RESPONSECHECKTX = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, json_name='gas_wanted', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, json_name='gas_used', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z+github.com/tendermint/tendermint/abci/types'))
_CHECKTXTYPE.values_by_name["NEW"].has_options = True
_CHECKTXTYPE.values_by_name["NEW"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\212\235 \003New'))
_CHECKTXTYPE.values_by_name["RECHECK"].has_options = True
_CHECKTXTYPE.values_by_name["RECHECK"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\212\235 \007Recheck'))
...
_TXRESULT.fields_by_name['result'].has_options = True
_TXRESULT.fields_by_name['result']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
