...
_COMMITINFO.fields_by_name['store_infos'].has_options = True
_COMMITINFO.fields_by_name['store_infos']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_STOREINFO.fields_by_name['commit_id'].has_options = True
_STOREINFO.fields_by_name['commit_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_COMMITID.has_options = True
_COMMITID._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\230\240\037\000'))
