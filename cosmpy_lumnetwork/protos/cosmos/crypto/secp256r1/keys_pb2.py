...
_PUBKEY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\332\336\037\007ecdsaPK')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_PRIVKEY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\332\336\037\007ecdsaSK')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z2github.com/cosmos/cosmos-sdk/crypto/keys/secp256r1\310\343\036\001\330\341\036\000\310\341\036\000'))
_PUBKEY.fields_by_name['key'].has_options = True
_PUBKEY.fields_by_name['key']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\332\336\037\007ecdsaPK'))
_PRIVKEY.fields_by_name['secret'].has_options = True
_PRIVKEY.fields_by_name['secret']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\332\336\037\007ecdsaSK'))
