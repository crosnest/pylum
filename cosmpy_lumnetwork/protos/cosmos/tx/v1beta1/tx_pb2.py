...
_FEE.fields_by_name['amount'].has_options = True
_FEE.fields_by_name['amount']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'))
_FEE.fields_by_name['payer'].has_options = True
_FEE.fields_by_name['payer']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\024cosmos.AddressString'))
_FEE.fields_by_name['granter'].has_options = True
_FEE.fields_by_name['granter']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\024cosmos.AddressString'))
_TIP.fields_by_name['amount'].has_options = True
_TIP.fields_by_name['amount']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'))
_TIP.fields_by_name['tipper'].has_options = True
_TIP.fields_by_name['tipper']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\024cosmos.AddressString'))
_AUXSIGNERDATA.fields_by_name['address'].has_options = True
_AUXSIGNERDATA.fields_by_name['address']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\024cosmos.AddressString'))
