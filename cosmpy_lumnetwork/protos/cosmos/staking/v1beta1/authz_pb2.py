...
_STAKEAUTHORIZATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_STAKEAUTHORIZATION_VALIDATORS.fields_by_name['address'].has_options = True
_STAKEAUTHORIZATION_VALIDATORS.fields_by_name['address']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\024cosmos.AddressString'))
_STAKEAUTHORIZATION.fields_by_name['max_tokens'].has_options = True
_STAKEAUTHORIZATION.fields_by_name['max_tokens']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\252\337\037\'github.com/cosmos/cosmos-sdk/types.Coin'))
_STAKEAUTHORIZATION.has_options = True
_STAKEAUTHORIZATION._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\312\264-\rAuthorization'))
