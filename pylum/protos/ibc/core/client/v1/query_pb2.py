...
_QUERYCLIENTSTATERESPONSE.fields_by_name['proof_height'].has_options = True
_QUERYCLIENTSTATERESPONSE.fields_by_name['proof_height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCLIENTSTATESRESPONSE.fields_by_name['client_states'].has_options = True
_QUERYCLIENTSTATESRESPONSE.fields_by_name['client_states']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\252\337\037\026IdentifiedClientStates'))
_QUERYCONSENSUSSTATERESPONSE.fields_by_name['proof_height'].has_options = True
_QUERYCONSENSUSSTATERESPONSE.fields_by_name['proof_height']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCONSENSUSSTATESRESPONSE.fields_by_name['consensus_states'].has_options = True
_QUERYCONSENSUSSTATESRESPONSE.fields_by_name['consensus_states']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_QUERYCONSENSUSSTATEHEIGHTSRESPONSE.fields_by_name['consensus_state_heights'].has_options = True
_QUERYCONSENSUSSTATEHEIGHTSRESPONSE.fields_by_name['consensus_state_heights']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002/\022-/ibc/core/client/v1/client_states/{client_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='ClientStates',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002#\022!/ibc/core/client/v1/client_states')),
  ),
  _descriptor.MethodDescriptor(
    name='ConsensusState',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002f\022d/ibc/core/client/v1/consensus_states/{client_id}/revision/{revision_number}/height/{revision_height}')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0022\0220/ibc/core/client/v1/consensus_states/{client_id}')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002:\0228/ibc/core/client/v1/consensus_states/{client_id}/heights')),
  ),
  _descriptor.MethodDescriptor(
    name='ClientStatus',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002/\022-/ibc/core/client/v1/client_status/{client_id}')),
  ),
  _descriptor.MethodDescriptor(
    name='ClientParams',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\027\022\025/ibc/client/v1/params')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002,\022*/ibc/core/client/v1/upgraded_client_states')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002/\022-/ibc/core/client/v1/upgraded_consensus_states')),
  ),
])
