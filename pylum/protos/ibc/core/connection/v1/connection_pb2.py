...
_IDENTIFIEDCONNECTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\tyaml:\"id\"')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_PARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\"yaml:\"max_expected_time_per_block\"')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
ConnectionEnd = _reflection.GeneratedProtocolMessageType('ConnectionEnd', (_message.Message,), dict(
...
IdentifiedConnection = _reflection.GeneratedProtocolMessageType('IdentifiedConnection', (_message.Message,), dict(
...
ClientPaths = _reflection.GeneratedProtocolMessageType('ClientPaths', (_message.Message,), dict(
...
ConnectionPaths = _reflection.GeneratedProtocolMessageType('ConnectionPaths', (_message.Message,), dict(
...
_CONNECTIONEND.fields_by_name['client_id'].has_options = True
_CONNECTIONEND.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_CONNECTIONEND.fields_by_name['counterparty'].has_options = True
_CONNECTIONEND.fields_by_name['counterparty']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_CONNECTIONEND.fields_by_name['delay_period'].has_options = True
_CONNECTIONEND.fields_by_name['delay_period']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\023yaml:\"delay_period\"'))
_CONNECTIONEND.has_options = True
_CONNECTIONEND._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000'))
_IDENTIFIEDCONNECTION.fields_by_name['id'].has_options = True
_IDENTIFIEDCONNECTION.fields_by_name['id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\tyaml:\"id\"'))
_IDENTIFIEDCONNECTION.fields_by_name['client_id'].has_options = True
_IDENTIFIEDCONNECTION.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_IDENTIFIEDCONNECTION.fields_by_name['counterparty'].has_options = True
_IDENTIFIEDCONNECTION.fields_by_name['counterparty']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_IDENTIFIEDCONNECTION.fields_by_name['delay_period'].has_options = True
_IDENTIFIEDCONNECTION.fields_by_name['delay_period']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\023yaml:\"delay_period\"'))
_IDENTIFIEDCONNECTION.has_options = True
_IDENTIFIEDCONNECTION._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000'))
_COUNTERPARTY.fields_by_name['client_id'].has_options = True
_COUNTERPARTY.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_COUNTERPARTY.fields_by_name['connection_id'].has_options = True
_COUNTERPARTY.fields_by_name['connection_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\024yaml:\"connection_id\"'))
_COUNTERPARTY.fields_by_name['prefix'].has_options = True
_COUNTERPARTY.fields_by_name['prefix']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
...
_CONNECTIONPATHS.fields_by_name['client_id'].has_options = True
_CONNECTIONPATHS.fields_by_name['client_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\020yaml:\"client_id\"'))
_VERSION.has_options = True
_VERSION._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000'))
_PARAMS.fields_by_name['max_expected_time_per_block'].has_options = True
_PARAMS.fields_by_name['max_expected_time_per_block']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\"yaml:\"max_expected_time_per_block\"'))
