...
_GENESISSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\362\336\037\036yaml:\"client_connection_paths\"')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\037yaml:\"next_connection_sequence\"')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_GENESISSTATE.fields_by_name['connections'].has_options = True
_GENESISSTATE.fields_by_name['connections']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_GENESISSTATE.fields_by_name['client_connection_paths'].has_options = True
_GENESISSTATE.fields_by_name['client_connection_paths']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\362\336\037\036yaml:\"client_connection_paths\"'))
_GENESISSTATE.fields_by_name['next_connection_sequence'].has_options = True
_GENESISSTATE.fields_by_name['next_connection_sequence']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\362\336\037\037yaml:\"next_connection_sequence\"'))
