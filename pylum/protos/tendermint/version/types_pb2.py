...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z9github.com/tendermint/tendermint/proto/tendermint/version'))
_CONSENSUS.has_options = True
_CONSENSUS._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\001'))
