...
_DUPLICATEVOTEEVIDENCE.fields_by_name['timestamp'].has_options = True
_DUPLICATEVOTEEVIDENCE.fields_by_name['timestamp']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\220\337\037\001'))
_LIGHTCLIENTATTACKEVIDENCE.fields_by_name['timestamp'].has_options = True
_LIGHTCLIENTATTACKEVIDENCE.fields_by_name['timestamp']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\220\337\037\001'))
_EVIDENCELIST.fields_by_name['evidence'].has_options = True
_EVIDENCELIST.fields_by_name['evidence']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
