...
_VALIDATORPARAMS = _descriptor.Descriptor(
  ...
  options=_descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\270\240\037\001\350\240\037\001')),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z7github.com/tendermint/tendermint/proto/tendermint/types\250\342\036\001'))
_CONSENSUSPARAMS.fields_by_name['block'].has_options = True
_CONSENSUSPARAMS.fields_by_name['block']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_CONSENSUSPARAMS.fields_by_name['evidence'].has_options = True
_CONSENSUSPARAMS.fields_by_name['evidence']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_CONSENSUSPARAMS.fields_by_name['validator'].has_options = True
_CONSENSUSPARAMS.fields_by_name['validator']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_CONSENSUSPARAMS.fields_by_name['version'].has_options = True
_CONSENSUSPARAMS.fields_by_name['version']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_EVIDENCEPARAMS.fields_by_name['max_age_duration'].has_options = True
_EVIDENCEPARAMS.fields_by_name['max_age_duration']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\230\337\037\001'))
_VALIDATORPARAMS.has_options = True
_VALIDATORPARAMS._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\270\240\037\001\350\240\037\001'))
_VERSIONPARAMS.has_options = True
_VERSIONPARAMS._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\270\240\037\001\350\240\037\001'))
