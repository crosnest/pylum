...
_PROTOCOLVERSION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\003P2P')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_DEFAULTNODEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\rDefaultNodeID')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z5github.com/tendermint/tendermint/proto/tendermint/p2p'))
_NETADDRESS.fields_by_name['id'].has_options = True
_NETADDRESS.fields_by_name['id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\002ID'))
_NETADDRESS.fields_by_name['ip'].has_options = True
_NETADDRESS.fields_by_name['ip']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\002IP'))
_PROTOCOLVERSION.fields_by_name['p2p'].has_options = True
_PROTOCOLVERSION.fields_by_name['p2p']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\003P2P'))
_DEFAULTNODEINFO.fields_by_name['protocol_version'].has_options = True
_DEFAULTNODEINFO.fields_by_name['protocol_version']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_DEFAULTNODEINFO.fields_by_name['default_node_id'].has_options = True
_DEFAULTNODEINFO.fields_by_name['default_node_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\rDefaultNodeID'))
_DEFAULTNODEINFO.fields_by_name['other'].has_options = True
_DEFAULTNODEINFO.fields_by_name['other']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000'))
_DEFAULTNODEINFOOTHER.fields_by_name['rpc_address'].has_options = True
_DEFAULTNODEINFOOTHER.fields_by_name['rpc_address']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\nRPCAddress'))
