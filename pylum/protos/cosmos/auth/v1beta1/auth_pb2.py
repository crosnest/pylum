...
_BASEACCOUNT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\024public_key,omitempty')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
  ...
  options=_descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000\230\240\037\000\350\240\037\000\312\264-\010AccountI')),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_MODULEACCOUNT = _descriptor.Descriptor(
  ...
  options=_descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000\230\240\037\000\312\264-\016ModuleAccountI')),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_PARAMS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\024SigVerifyCostED25519')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\026SigVerifyCostSecp256k1')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_BASEACCOUNT.fields_by_name['address'].has_options = True
_BASEACCOUNT.fields_by_name['address']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\024cosmos.AddressString'))
_BASEACCOUNT.fields_by_name['pub_key'].has_options = True
_BASEACCOUNT.fields_by_name['pub_key']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\352\336\037\024public_key,omitempty'))
_BASEACCOUNT.has_options = True
_BASEACCOUNT._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000\230\240\037\000\350\240\037\000\312\264-\010AccountI'))
_MODULEACCOUNT.fields_by_name['base_account'].has_options = True
_MODULEACCOUNT.fields_by_name['base_account']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\320\336\037\001'))
_MODULEACCOUNT.has_options = True
_MODULEACCOUNT._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\210\240\037\000\230\240\037\000\312\264-\016ModuleAccountI'))
_PARAMS.fields_by_name['sig_verify_cost_ed25519'].has_options = True
_PARAMS.fields_by_name['sig_verify_cost_ed25519']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\024SigVerifyCostED25519'))
_PARAMS.fields_by_name['sig_verify_cost_secp256k1'].has_options = True
_PARAMS.fields_by_name['sig_verify_cost_secp256k1']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\342\336\037\026SigVerifyCostSecp256k1'))
