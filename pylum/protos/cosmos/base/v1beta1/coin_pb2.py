...
_DECCOIN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\ncosmos.Dec\332\336\037\003Dec\310\336\037\000')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z\"github.com/cosmos/cosmos-sdk/types\330\341\036\000\200\342\036\000'))
_COIN.fields_by_name['amount'].has_options = True
_COIN.fields_by_name['amount']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\ncosmos.Int\332\336\037\003Int\310\336\037\000'))
_COIN.has_options = True
_COIN._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\001'))
_DECCOIN.fields_by_name['amount'].has_options = True
_DECCOIN.fields_by_name['amount']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\ncosmos.Dec\332\336\037\003Dec\310\336\037\000'))
_DECCOIN.has_options = True
_DECCOIN._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('\350\240\037\001'))
_INTPROTO.fields_by_name['int'].has_options = True
_INTPROTO.fields_by_name['int']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\ncosmos.Int\332\336\037\003Int\310\336\037\000'))
_DECPROTO.fields_by_name['dec'].has_options = True
_DECPROTO.fields_by_name['dec']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\322\264-\ncosmos.Dec\332\336\037\003Dec\310\336\037\000'))
