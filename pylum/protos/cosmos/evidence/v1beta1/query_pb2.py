...
_QUERYEVIDENCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\372\336\0374github.com/tendermint/tendermint/libs/bytes.HexBytes')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_QUERYEVIDENCEREQUEST.fields_by_name['evidence_hash'].has_options = True
_QUERYEVIDENCEREQUEST.fields_by_name['evidence_hash']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\372\336\0374github.com/tendermint/tendermint/libs/bytes.HexBytes'))
...
_QUERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0023\0221/cosmos/evidence/v1beta1/evidence/{evidence_hash}')),
  ),
  _descriptor.MethodDescriptor(
    name='AllEvidence',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002#\022!/cosmos/evidence/v1beta1/evidence')),
  ),
])
