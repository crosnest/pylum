...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z%github.com/cosmos/cosmos-sdk/types/tx'))
_GETTXSEVENTREQUEST.fields_by_name['pagination'].has_options = True
_GETTXSEVENTREQUEST.fields_by_name['pagination']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_GETTXSEVENTRESPONSE.fields_by_name['pagination'].has_options = True
_GETTXSEVENTRESPONSE.fields_by_name['pagination']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_SIMULATEREQUEST.fields_by_name['tx'].has_options = True
_SIMULATEREQUEST.fields_by_name['tx']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
...
_SERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \"\033/cosmos/tx/v1beta1/simulate:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetTx',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\037\022\035/cosmos/tx/v1beta1/txs/{hash}')),
  ),
  _descriptor.MethodDescriptor(
    name='BroadcastTx',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\033\"\026/cosmos/tx/v1beta1/txs:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='GetTxsEvent',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\030\022\026/cosmos/tx/v1beta1/txs')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\'\022%/cosmos/tx/v1beta1/txs/block/{height}')),
  ),
])
