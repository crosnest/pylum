...
_SIGNMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGN_MODE_DIRECT_AUX', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGN_MODE_LEGACY_AMINO_JSON', index=4, number=127,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SIGN_MODE_EIP_191', index=5, number=191,
      options=None,
      type=None),
  ],
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z-github.com/cosmos/cosmos-sdk/types/tx/signing'))
